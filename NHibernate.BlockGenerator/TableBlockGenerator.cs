...
namespace NHibernate.Id
{
	...
	/// </p>
	/// </remarks>
	public class TableBlockGenerator : EnhancedTableGenerator
	{
        private static readonly IInternalLogger log = LoggerProvider.LoggerFor(typeof(TableBlockGenerator));
		...
		/// <param name="dialect">The <see cref="NHibernate.Dialect.Dialect"/> to help with Configuration.</param>
